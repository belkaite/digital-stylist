...
class MockWardrobeService(WardrobeService):
    def __init__(self):
        self.wardrobe_items = [
            WardrobeItem(id=1, name="blue jeans", type="trousers", occasion=["everyday"], season=["winter", "autumn"], image_path="", image_source=""),
            WardrobeItem(id=2, name="summer shorts", type="trousers", occasion=["everyday"], season=["summer"], image_path="", image_source="")
        ]
